...
#define STDIN_FILENO    3       /* standard input file descriptor */
#define STDOUT_FILENO   4       /* standard output file descriptor */
#define STDERR_FILENO   5       /* standard error file descriptor */
